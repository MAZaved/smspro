...
//                                foreach ($caname as $cn)
//                                {
//
//                                    $class_name = $cn['name'];
//                                }
                                ?>
                                <input type="text" class="form-control" name="class_id" value="<?php echo $class_id?>" readonly/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                               ...
                               foreach($teachers as $teacher) {
                                   ...
                                   $teacher_arr[$teacher->teacher_id] = $teacher->name;
                               }

                              echo  form_multiselect('teacher_id',array(''=>'Select')+ $teacher_arr,'class="form-control select"') ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
